...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000d6ac556ec787791bcc27189feda03c7cd73c471adad4e28e4cd8dd8e026"))
	;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1535379313, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nEnforceNewSporkKey = 1535379313; //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1535379313; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1535379313;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1421607;
/*if (genesis.GetHash() != hashGenesisBlock) {
        ...
        assert(hashGenesisBlock == uint256("0x00000d6ac556ec787791bcc27189feda03c7cd73c471adad4e28e4cd8dd8e026"));
        ...
        nStartMasternodePayments = 1535379313; //11/10/2017 @ 12:00am (UTC)
