...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "NXBoost server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"nxboost", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nxboost", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nxboost", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nxboost", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nxboost", "masternodedebug", &masternodedebug, true, true, false},
        {"nxboost", "startmasternode", &startmasternode, true, true, false},
        {"nxboost", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nxboost", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nxboost", "listmasternodeconf", &listmasternodeconf, true, true, false},
        ...
        {"nxboost", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nxboost", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nxboost", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nxboost", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nxboost", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nxboost", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nxboost", "checkbudgets", &checkbudgets, true, true, false},
        {"nxboost", "mnsync", &mnsync, true, true, false},
        {"nxboost", "spork", &spork, true, true, false},
        {"nxboost", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzNXBseed", &getzNXBseed, false, false, true},
        {"zerocoin", "setzNXBseed", &setzNXBseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzNXB", &searchdzNXB, false, false, true},
        {"zerocoin", "dzNXBstate", &dzNXBstate, false, false, true}
...
{
    return "> nxboost-cli " + methodname + " " + args + "\n";
}
