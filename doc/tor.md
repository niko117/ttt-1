...
Run NXBoost behind a Tor proxy
----------------------------------

The first step is running NXBoost behind a Tor proxy. This will already make all
...
```
./nxboostd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./nxboostd -proxy=127.0.0.1:9050
```

Run a NXBoost hidden server
-------------------------------
...
HiddenServicePort 989 127.0.0.1:49095
...
your nxboostd's P2P listen port (49095 by default).
```
...
```
./nxboostd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 49095 on your firewall (or use -upnp).

If you only want to use Tor to reach onion addresses, but not use it as a proxy
for normal IPv4/IPv6 communication, use:
```
./nxboostd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known NXBoost Tor relays
------------------------------------
```
